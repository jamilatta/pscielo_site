...
class Journal(DocType):
    ...
    init_year = Integer(index='not_analyzed')
    init_vol = Integer(index='not_analyzed')
    init_num = Integer(index='not_analyzed')
    final_num = Integer(index='not_analyzed')
    final_vol = Integer(index='not_analyzed')
    final_year = Integer(index='not_analyzed')
